<div class="destination">
    ...
    <div class="destination__wrapper">
        ...
        <a class="destination__button button -color-black" href="{$smarty.const.PROTOCOL}{$featured_item->subdomain}.{$smarty.const.SERVER_NAME}" title="See all properties">{$featured_item->properties_count} Properties</a>
    </div>
</div>