        ...
        <form class="form--letter form--letter-alt filter js-validate-form" id="contact-site-form" method="post" action="/form/contact">
            <div class="form--letter__wrapper">
                ...
                <div class="form__input__container filter__input__container form--letter__input__container -full-width -has-select2">
                    ...
                    <select class="js-select2 -has-select2 form__input form--letter__input filter__input" name="what">
            ...
            <div class="form--letter__input__container -has-textarea">
                ...
                <textarea class="js-textarea form--letter__input -anchor-textarea" name="message" rows="3" required></textarea>
            </div>
