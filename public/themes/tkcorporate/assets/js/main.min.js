...
var start=$(".featured__item").length,amenities=[];document.getElementById("ck-beach").checked&&amenities.push("ck-beach"),document.getElementById("ck-city").checked&&amenities.push("ck-city");var filters={amenities:amenities,reservations:{start:$('input[name="startdate"]').val(),end:$('input[name="enddate"]').val()},group:{all:document.getElementById("ck-all").checked,specials:document.getElementById("ck-sp").checked,favorites:document.getElementById("ck-fav").checked}};load($('input[name="q"]').val(),start,20,filters)})}return __init()}};jQuery(document).ready(function(){travelkeys.init()}),jQuery(window).load(function(){});
