    ...
    <div class="featured__wrapper">
        <div class="featured__item__wrapper">
            <h3 class="featured__item__title">
                <a href="#todo" title="{$search_item->name}"><i class="icon icon__heart-featured"></i><span>{$search_item->name}</span></a>
            </h3>
        ...
        <div class="featured__item__buttons">
            <div class="featured__item__button">
                <a class="button -color-black" href="#todo" title="View villa">View villa</a>
            </div>
            <div class="featured__item__button">
