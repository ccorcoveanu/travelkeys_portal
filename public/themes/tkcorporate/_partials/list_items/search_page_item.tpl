    ...
    <div class="featured__wrapper">
        ...
        <div class="featured__item__section">
            ...
            <div class="featured__item__price">
                ...
                <strong class="price__number"><sup class="price__super">$</sup>{$search_item->min_rate|default:'TBA'}/nt</strong>
            </div>
        </div>
        <div class="featured__item__buttons">
            ...
            <div class="featured__item__button">
                <button
                        ...
                        title="Calendar">Calendar<i class="icon icon__date-square"></i></button>
            </div>
        </div>
    </div>
</section>