<footer class="footer">
        ...
        <div class="footer__container">
            ...
            <div class="footer__contact">
                ...
                <div class="footer__contact__item -first">
                    <a class="footer__contact__item__link" href="tel:8778151242" title="Call 877.875.9877">877.815.1242</a>
    ...
    <div class="footer__nav">
        ...
        <ul class="footer__site-map">
            <li class="footer__site-map__item"><a href="{$smarty.const.MAIN_SITE}/terms-of-use" title="Terms of use">Terms of use</a>
            </li>
            <li class="footer__site-map__item"><a href="{$smarty.const.MAIN_SITE}/privacy-policy" title="Privacy Policy">Privacy Policy</a>
            </li>
