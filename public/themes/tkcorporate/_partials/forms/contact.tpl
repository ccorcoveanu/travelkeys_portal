<form class="form--letter form--letter-alt filter" method="post" action="/form/contact">
    <div class="form--letter__wrapper">
        <div class="form--letter__input__container -half-width">
            ...
            <input class="form--letter__input" type="text" name="first_name">
        </div>
        <div class="form--letter__input__container -half-width">
            <label class="form--letter__label">Last name:</label>
            <input class="form--letter__input" type="text" name="last_name">
        </div>
        <div class="form--letter__input__container -half-width">
